...
- Next work item: P15.3 — Add the application theme runtime and first-frame restoration
...
- [x] **P13.5** Symbols lexer and parser
- [x] **P13.6** Include resolution
...
- [x] **P13.11** Host layout detection and startup import
- [x] **P13.12** Import test coverage

**Phase status:** 12/12 work items complete. Phase complete.

## Phase 14 — Import-derived per-user XKB variants

- [x] **P14.1** Persist project identity and an immutable derivation baseline
- [x] **P14.2** Add neutral diffing and derived-variant translation
...
- [x] **P14.7** Add the explicit user-variant UI workflow
- [x] **P14.8** Close compatibility, integration, and recovery coverage
...
**Phase status:** 2/8 work items complete. Phase in progress.

## Progress summary

- Completed work items: **104**
- Total planned work items: **110**
- Overall checklist progress: **104/110**
